const DICTS = {
  ...
  ru: {
    ...
    settings: 'Настройки',
    theme: 'Тема',
    editTheme: 'Редактирование CSS темы',
    uiScale: 'Масштаб UI',
    nodeDensity: 'Плотность нод',
    shadows: 'Тени нод',
    grid: 'Фоновая сетка',
    saveTheme: 'Сохранить кастомную тему',
    resetTheme: 'Сбросить кастомную тему',
