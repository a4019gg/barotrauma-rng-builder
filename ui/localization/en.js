export const enUiDictionary = {
    ...
    editableLabelsAdvanced: 'Editable labels (Advanced mode only)',
    ...
    gridTooltip: 'Show or hide the editor background grid.',
    showButtonIconsTooltip: 'Display icons next to button labels across the interface.',
    editableLabelsTooltip: 'Allow editing RNG branch labels in node cards (available only in Advanced mode).',
    softStartTooltip: 'Skip startup resource preloading to launch the app faster.',
