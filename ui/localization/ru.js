export const ruUiDictionary = {
    ...
    projectImportPlaceholderDescription: 'Диалог-заглушка импорта: загрузите файл проекта или перетащите его сюда. Ручной ввод JSON отключен.',
    projectImportDropHint: 'Пока принимаются только .json файлы проекта (заглушка)',
    projectImportActionPlaceholder: 'Импорт проекта (заглушка)',
