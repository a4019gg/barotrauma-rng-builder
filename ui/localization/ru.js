export const ruUiDictionary = {
    ...
    editableLabelsAdvanced: 'Редактируемые Labels (только Advanced mode)',
    softStart: 'Мягкий запуск',
    ...
    gridTooltip: 'Показывает или скрывает фоновую сетку редактора.',
    showButtonIconsTooltip: 'Отображает иконки рядом с названиями кнопок по всему интерфейсу.',
    editableLabelsTooltip: 'Разрешает редактировать названия RNG-веток в карточках нод (доступно только в Advanced mode).',
    softStartTooltip: 'Пропускает предзагрузку ресурсов при старте для более быстрого запуска.',
