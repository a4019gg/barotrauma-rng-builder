// js/xml.js — v0.9.113 — ВАЛИДАЦИЯ + ЛОКАЛИЗАЦИЯ

const XML_VERSION = "v0.9.113";
...
function generateXML() {
  ...
  if (xmlFormat === 'comments') {
    xml += `\n  <!-- ${L.xmlGeneratedBy || 'Generated by Barotrauma RNG Builder v0.9.113'} -->`;
  }
  ...
  if (issues.length > 0) {
    alert(`${L.validationTitle || 'Валидация XML'}\n\n${issues.join('\n')}`);
  }
